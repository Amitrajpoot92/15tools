...
import { Fuel, Copy, Check } from "lucide-react";
...
Fuel Efficiency: ${efficiency || 0}
Fuel Price (per unit): ${price || 0}
Fuel Required: ${result.needed} units
Total Fuel Cost: ${result.cost}
