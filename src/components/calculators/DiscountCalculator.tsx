      ...
      <div className="space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              {discountType === "flat" && <span className="absolute left-4 top-1/2 -translate-y-1/2 text-lg text-slate-400 font-bold">₹</span>}
              <input 
                type="number" 
                value={discount} 
        ...
        <div className="bg-[#f0fdf4] border border-emerald-100 rounded-2xl p-5 md:p-6 mt-5 relative overflow-hidden">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-1.5">
              <button onClick={() => copyToClipboard(`Original Price: ₹${res.price} | Discount: ₹${res.totalSaved} | Final Payable Price: ₹${res.finalPrice}`)} className="flex items-center gap-1 px-2.5 py-1.5 bg-white border border-emerald-200 rounded-md text-xs font-bold text-emerald-700 hover:bg-emerald-50 transition-colors shadow-sm">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-5">
            <div className="flex items-baseline">
              <span className="text-2xl font-bold text-emerald-950 mr-1">₹</span>
          ...
          <div className="grid grid-cols-2 gap-4 pt-3 border-t border-emerald-200/50">
            <div>
              ...
              <p className="text-sm font-bold text-emerald-900">₹{res.price}</p>
            </div>
            <div>
              <p className="text-[10px] font-bold text-emerald-700 mb-0.5 uppercase tracking-wider">You Save</p>
              <p className="text-sm font-bold text-emerald-700">-₹{res.totalSaved}</p>
            </div>
          </div>
        </div>
      </div>
