  ...
  return (
    <div className="pb-8">
      ...
      <div className="max-w-4xl mx-auto mb-10 bg-white rounded-3xl p-4 md:p-6 shadow-sm border border-slate-200 mt-2">
        ...
        <div className="flex items-center gap-4 md:gap-6 bg-indigo-50/50 rounded-2xl p-4 md:p-6 mb-6 border border-indigo-100/50">
          <div className="hidden sm:flex flex-shrink-0 items-center justify-center w-16 h-16 bg-indigo-600 rounded-2xl shadow-sm shadow-indigo-600/20">
            <CreditCard className="w-8 h-8 text-white" />
          </div>
          <div>
            <h2 className="text-[10px] md:text-xs font-bold text-indigo-600 uppercase tracking-wider mb-1">EMI</h2>
